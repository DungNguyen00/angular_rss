...
const apiUrl = 'https://tuoitre.vn/rss/nhip-song-tre.rss';
@Component({
  selector: 'app-life-style-young',
  templateUrl: './life-style-young.component.html',
  styleUrls: ['../own-categories.component.sass']
})
export class LifeStyleYoungComponent implements OnInit {
